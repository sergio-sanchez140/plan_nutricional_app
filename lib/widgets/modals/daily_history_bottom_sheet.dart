          ...
          Expanded(
            child: FutureBuilder<Map<String, dynamic>>(
              ...
              builder: (context, snapshot) {
                ...
                final meta =
                    data['calorias_objetivo_del_dia'] ??
                    data['meta_calorias'] ??
                    2000;
                    ...
                    children: [
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${calorias.toInt()} / ${meta.toInt()} kcal",
                                  style: TextStyle(
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold,
                                    color: calorias > meta
                            ...
                            Row(
                              ...
                              children: [
                                _buildMacroMini(
                                  "Carbos",
                                  "${macros['carbohidratos_g'] ?? 0}g",
                                  Colors.blue,
                                ),
                                _buildMacroMini(
                                  "Proteína",
                                  "${macros['proteinas_g'] ?? 0}g",
                                  Colors.red,
                                ),
                                _buildMacroMini(
                                  "Grasas",
                      ...
                      if (comidas.isEmpty)
                        Padding(
                          ...
                          child: Center(
                            child: Text(
                              "No hay detalles de comidas para este día.",
                              style: TextStyle(color: Colors.grey.shade500),
                            ),
                          ),
                        )
                      else
                        ...comidas.map((c) => _buildMealRow(c)),
